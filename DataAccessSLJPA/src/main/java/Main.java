...
//        System.out.println(projectController.getAllProjectsJSON());
        ...
        try {
            repositoryService.getAllRepositories().forEach(System.out::println);
        } catch (SQLException e) {
            e.printStackTrace();
        }

        RepositoryController repositoryController = RepositoryController.getInstance();
        System.out.println("Reposn't");
        System.out.println(repositoryController.getAllRepositoriesJSON());
    }
}
