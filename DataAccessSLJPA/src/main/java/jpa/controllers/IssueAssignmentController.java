...
public class IssueAssignmentController {
    ...
    public String deleteIssueAssignmentJSON(IssueAssignmentDTO issueAssignment) {
        try {
            ...
            System.err.println("Error al borrar IssueAssignment con id " + issueAssignment.getId() + ": " + e.getMessage());
            return "Error al borrar IssueAssignment con id " + issueAssignment.getId() + ": " + e.getMessage();
        }
    }
}
